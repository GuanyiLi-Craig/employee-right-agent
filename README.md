...
names a provision and a provision exists in one document. `evals/baseline.json`
...
Thresholds live in [`evals/baseline.json`](evals/baseline.json), set *below*
...
presentation/           the deck and speaker notes this build is scoped to
```
